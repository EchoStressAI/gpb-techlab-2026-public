...
Публично безопасная сводка текущих aggregate results вынесена отдельно: [PUBLIC_VALIDATION_RESULTS.md](PUBLIC_VALIDATION_RESULTS.md). Она не заменяет этот protocol и не должна читаться без указанных в ней ограничений.
